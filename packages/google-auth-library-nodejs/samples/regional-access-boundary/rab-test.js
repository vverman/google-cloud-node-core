...
async function main() {
  ...
  process.env.GOOGLE_APPLICATION_CREDENTIALS =
    // '/Users/pjiyer/Documents/google-auth-adc/workforce/wf_test.json'; //headful.
  // '/Users/pjiyer/.config/gcloud/application_default_credentials.json'; //headless workforce.
  // '/home/ec2-user/aws-credentials.json'; // <---- AWS.
  // '/Users/pjiyer/Documents/google-auth-adc/x509/x509_credential_config.json'; // <---- X509 Certificate.
  ...
  // '/Users/pjiyer/Documents/google-auth-adc/okta-saml-workload/saml_config.json'; // <------- SAML Workload.
  ...
  //  '/Users/pjiyer/Documents/google_auth_library/NodeJS/pjiyer-cloud-node-core/google-cloud-node-core/packages/google-auth-library-nodejs/samples/okta_pluggable_config.json'; // <------- Okta Pluggable Auth Service Account.
